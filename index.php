    ...
    <nav class="navbar navbar-expand-lg navbar-dark mt-0 pt-4 pb-4 " >
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a  class="nav-link active scrollto" href="#hero"> Home</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item dropdown">
                        <button  class="nav-link dropdown-toggle" href="#" id="navbarDropdown" data-toggle="dropdown" style="background-color: #2d833f;">Log In</button>
                        <div class="dropdown-menu">
                             <button type="button"   onclick="document.getElementById('id01').style.display='block'" style="width:auto;background-color: #2d833f; color: white;">Admin &nbsp;</button><br><br>
                            <button type="button"  onclick="document.getElementById('id02').style.display='block'" style="width:auto;background-color: #2d833f; color: white;">Student</button>
                        </div>
                    </li>
                     </li>
             ...
             <?php
                 session_start();
                    if(isset($_SESSION["login_error"])){
                        ...
                        echo '<br><p style="font-size: 14px; color:darkred; text-align:center; ">'.$error.'!!</p>';
                    }else
                    echo '';
     ...
     <div style="height: 115px;"></div>
        ...
        <div class="col-md-4">
            ...
            <div class="card-body text-center" style="background-color:#e2aa22; "><button style="border-radius: 3px; border: none; padding-left: 10px; background-color: #2d833f;color: white; height: 50px; font-size: 1.5em; "><a href="viewmenu0.php" style="color: white;">Order food Now!</a></button></div>
            </div>
        </div>
        ...
        <div class="hero2 mt-4 mb-4 text-center" style="background-color: #f2f5ec; height: 200px; background-image: url('images.jpeg'); background-size: cover;"><br><br>
            <p style="color: #f2f5ec; font-weight: bold;font-size: 1.5em;"> Here is where you can find quality nice food &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><button style="border:1px solid #e2aa22;border-radius: 20%; background-color: transparent; color: #e2aa22;"><a href="viewmenu0.php" style="color: #000000">View menu</a></button></span></p>
        </div>


<div id="id01" class="modal">
  <form class="modal-content animate" name="myForm" action="admin-login.php" method="post">
...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" name="myForm" action="student-login.php" method="post" onsubmit = "return(validate());">
    <div class="imgcontainer">
