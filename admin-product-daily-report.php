...
<body>
   <div class="admin-wraper" style="background-color: white">
    ...
    <div class="admin-content">
      ...
      <i class="page-title text-dark" style="font-size: 25px;"> Product report(daily)</i><span style="float: right;"><button style="color: red; font-weight: bold;"> <a href="order-report.php"> Other reports</a></button></span>
      <div class="content" style="border: 1px solid lightgray;"> 
        ...
        <a href="admin-product-daily-report.php" style="font-size: 20px; color: black;">daily<span style="color: black;">/</span></a>
        <a href="admin-product-weekly-report.php" style="font-size: 20px; color: lightblue;">weekly<span style="color: black;">/</span></a>
