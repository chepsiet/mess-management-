    ...
    <div class="left-sidebar" style="background-color: #c87437;height: 700px;">
      <ul>
		...
		<div class="admin-content">
			...
			<i class="page-title text-dark" style="font-size: 25px;"> Available item cartegory</i><span style="float: right;"><button style="color: red; font-weight: bold;"> <a href="admin-create-cartegory.php"> Add new cartegory</a></button></span>
...
$res=mysqli_query($conn,"SELECT* FROM cartegory ");

while ($row=mysqli_fetch_array($res)) {
	echo "<tr>";
	echo "<td>"; echo $row['cartegory_name']; echo "</td>";
	echo "<td>"; ?>  <a href="admin-update-cartegory.php? id=<?php echo $row['cartegory_id'];?>" class="btn-big"><button type="submit" class="btn  btn-sm btn-success" name="submit">edit</button></a> <?php echo "</td>";
echo "<td>"; ?> <a href="admin-delete-cartegory.php? id=<?php echo $row['cartegory_id'];?>" class="btn-big"><button type="submit" class="btn  btn-sm btn-denger" name="submit" style="background-color: #d05056; color: white;" >delete</button></a> <?php echo "</td>";
echo "</tr>";
