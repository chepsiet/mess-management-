   ...
   <div class="admin-wraper" style="background-color: white">
    ...
    <div class="admin-content">
     ...
     <div class="content" style="border: 1px solid lightgray;"> 
        <i style="font-size: 22px;">Order Report(weekly)</i><br>
        ...
        <a href="admin-report-weekly.php" style="font-size: 20px; color: black;">weekly<span style="color: black">/</span></a>
        <a href="admin-report-monthly.php" style="font-size: 20px; color: lightblue;">monthly </a>
				...
				<button type="submit" class="btn  btn-sm btn-success" name="weekly" style="background-color: #d05056; margin-left: 400px" >generate pdf</button></form>
				<table class="table">
