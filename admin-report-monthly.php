  ...
  <div class="admin-wraper" style="background-color: white">
    ...
    <div class="admin-content">
      ...
      <div class="content" style="border: 1px solid lightgray;"> 
        <i style="font-size: 22px;">Order Report(monthly)</i><br>
        ...
        <a href="admin-report-monthly.php" style="font-size: 20px; color: black;">monthly </a>
				<form method="post" action="order-report.php" style="float: right;">
				<button type="submit" class="btn  btn-sm btn-success" name="monthly" style="background-color: #d05056; margin-left: 400px" >generate pdf</button></form>
				<table class="table">
