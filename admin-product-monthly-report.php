...
<body>
   <div class="admin-wraper" style="background-color: white">
    ...
    <div class="admin-content">
      ...
      <i class="page-title text-dark" style="font-size: 25px;"> Product report(monthly)</i><span style="float: right;"><button style="color: red; font-weight: bold;"> <a href="order-report.php"> Other reports</a></button></span>
      <div class="content" style="border: 1px solid lightgray;"> 
        ...
        <a href="admin-product-monthly-report.php" style="font-size: 20px; color: black;">monthly</a>
        <table class="table">
